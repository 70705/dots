...
local run_and_notify_about_volume = function(command)
	awful.spawn.easy_async_with_shell(command, function(out)
		local command = "pamixer --get-volume-human"
		awful.spawn.easy_async_with_shell(command, function(out)
			local muted_command = "pacmd list-sinks | grep --color=never 'muted: *' | awk '{$1=$1};1'"
			awful.spawn.easy_async_with_shell(muted_command, function(muted_out)
				naughty.notify({ text = "Volume: " .. out .. muted_out, timeout = 1, replaces_id = -1 })
			end)
		end)
	end)
end
...
awful.util.tagnames = { "ESSENTIAL", "WEB", "CODING", "GAMING", "MISC" }
...
globalkeys = mytable.join(
	...
	awful.key({}, "Print", function()
		awful.util.spawn("screengrab")
	end, { description = "Print screen", group = "controls" }),

	awful.key({ "Control" }, "Print", function()
		awful.util.spawn("screengrab -r")
	end, { description = "Print screen", group = "controls" }),

	-- Rofi
	awful.key({ modkey }, "space", function()
		awful.spawn.with_shell("rofi -show drun -theme $HOME/.config/awesome/rofi/launcher.rasi")
	...
	awful.key({}, "XF86AudioLowerVolume", function()
		run_and_notify_about_volume("pamixer --allow-boost --set-limit 150 -d 5")
	end, { description = "lower volume", group = "system" }),
	awful.key({}, "XF86AudioRaiseVolume", function()
		run_and_notify_about_volume("pamixer --allow-boost --set-limit 150 -i 5")
	...
	end, { description = "next song", group = "system" }),
	awful.key({}, "XF86AudioPrev", function()
		awful.spawn("playerctl previous")
	end, { description = "previous song", group = "system" }),
	awful.key({}, "XF86AudioPlay", function()
		awful.spawn("playerctl play-pause")
	end, { description = "play-pause song", group = "system" }),
...
awful.rules.rules = {
	...
	{ rule = { class = "firefox" }, properties = { screen = 1, tag = "WEB", switchtotag = true } },
	{ rule = { class = "discord" }, properties = { screen = 1, tag = "ESSENTIAL", switchtotag = true } },
	{ rule = { class = "steam" }, properties = { screen = 1, tag = "ESSENTIAL", switchtotag = true } },
	{ rule = { class = "Spotify" }, properties = { screen = 1, tag = "MISC", switchtotag = true } },
}
